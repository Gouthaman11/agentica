    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0A0A0B] flex flex-col justify-center items-center p-6 selection:bg-indigo-500/30">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500">Sign in to access your financial intelligence.</p>
        </div>
        ...
        <p className="text-center font-medium text-sm text-slate-500 mt-8">
          Don't have an account? <Link to="/enhanced/signup" className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline">Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
